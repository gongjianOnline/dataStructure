...
Take.onclick = function () {
  n++;
  surplusData.push(n);
  current.innerHTML = "\u5F53\u524D\u53F7:".concat(n);
  surplus.innerHTML = "\u5F53\u524D\u961F\u5217:".concat(JSON.stringify(surplusData));
};
...
calling.onclick = function () {
  ...
  var del = surplusData.shift();
  view.innerHTML += "\u8BF7".concat(del, "\u53F7\u987E\u5BA2\u53D6\u9910<br>");
  surplus.innerHTML = "\u5F53\u524D\u961F\u5217:".concat(JSON.stringify(surplusData));
};
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2639" + '/');
